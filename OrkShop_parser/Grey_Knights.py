...
url_pars = 'https://goodork.ru/categories/adeptus-astartes-grey-knights'
...
os.system("python3.7 /home/kederly/PycharmProjects/Warhammer_parser/OrkShop_parser/Space_Marines.py")