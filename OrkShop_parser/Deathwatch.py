...
url_pars = 'https://goodork.ru/categories/adeptus-astartes-deathwatch'
...
os.system("python3.7 /home/kederly/PycharmProjects/Warhammer_parser/OrkShop_parser/Grey_Knights.py")